  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_month: "relative inline-flex h-8 items-center rounded-md border border-input bg-background px-2 text-sm",
        dropdown_year: "relative inline-flex h-8 items-center rounded-md border border-input bg-background px-2 text-sm",
