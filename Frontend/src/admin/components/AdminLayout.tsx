...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex">
      {/* Sidebar */}
      <aside className="hidden md:flex w-72 lg:w-80 shrink-0 flex-col border-r border-border bg-surface/40">
        <div className="px-5 lg:px-6 py-5 border-b border-border">
